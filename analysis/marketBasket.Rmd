...
```{r}
respect <- responses %>% 
  filter(str_detect(Copy.Dress.Code.Justification.Here, "established to teach grooming and hygiene, prevent disruption")) %>% 
  select(c(School.Name, School.State.Abbreviation, Copy.Dress.Code.Justification.Here))
```
